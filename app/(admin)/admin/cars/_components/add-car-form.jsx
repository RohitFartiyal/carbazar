...
import { Camera, ImagePlus, Loader2, X, Upload, RefreshCcw } from "lucide-react";
...
export const AddCarForm = () => {
  ...
  const onSubmit = async (data) => {
    ...
    // if(setValue("make")==null) return toast.error("Fill all feild")
        ...
        <TabsContent value="manual" className="mt-6">
          <Card>
            <CardHeader className="flex justify-between">
              ...
              <div>
              <Button onClick={refresh} >Refresh <RefreshCcw/></Button>
              {/* <CardDescription>
                To remove and start again
              </CardDescription> */}
              </div>
            </CardHeader>
            <CardContent>
